...
# Soil type dictionary with typical nutrient ranges
SOIL_TYPES = {
    'Sandy': {'N': (7, 12), 'P': (8, 13), 'K': (6, 11), 'pH': (5.5, 7.0)},
    'Clay': {'N': (12, 18), 'P': (15, 20), 'K': (14, 20), 'pH': (6.0, 7.0)},
    'Loamy': {'N': (14, 20), 'P': (12, 18), 'K': (12, 17), 'pH': (6.0, 7.5)},
    'Silt': {'N': (10, 15), 'P': (10, 15), 'K': (8, 13), 'pH': (5.5, 7.0)},
    'Peaty': {'N': (20, 25), 'P': (8, 13), 'K': (7, 12), 'pH': (4.5, 5.5)},
    'Chalky': {'N': (8, 13), 'P': (9, 14), 'K': (10, 15), 'pH': (7.0, 8.0)}
}
...
def crop_recommend():
    ...
    return render_template('crop-recommend.html', title=title, soil_types=SOIL_TYPES.keys())
